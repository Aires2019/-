...
<?php
	...
	else
	{
		...
		else
		{
			...
			require("menu.html");
			$sql="select users.userid,users.username,sum(totalnumber) totalnumber,sum(actualtotal) actualtotal,sum(total) total 
            from users,sale where users.userid=sale.userid 
